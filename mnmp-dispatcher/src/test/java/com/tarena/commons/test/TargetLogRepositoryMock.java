...
public class TargetLogRepositoryMock implements TargetLogRepository {
    ...
    @Override public void newSuccessSmsTargetLog(SmsNoticeEvent event, SmsTarget target, TargetStatus targetStatus,
        String bizId) {

    }

    @Override public void newFailSmsTargetLog(SmsNoticeEvent event, SmsTarget target, TargetStatus targetStatus,
        String errorMsg) {
